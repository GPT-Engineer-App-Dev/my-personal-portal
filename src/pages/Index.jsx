        ...
        <Box as="header" bg="brand.800" color="white" py={6}>
          <Flex justify="space-between" align="center" px={8} w="full">
            ...
            <Box display={{ base: "block", md: "flex" }} justifyContent="center" alignItems="center">
              <Link href="#about" display="flex" alignItems="center" justifyContent="center" px={6} py={2} _hover={{ textDecoration: "underline" }}><FaUser /><Text ml={2}>About</Text></Link>
              <Link href="#projects" display="flex" alignItems="center" justifyContent="center" px={6} py={2} _hover={{ textDecoration: "underline" }}><FaProjectDiagram /><Text ml={2}>Projects</Text></Link>
              <Link href="#contact" display="flex" alignItems="center" justifyContent="center" px={6} py={2} _hover={{ textDecoration: "underline" }}><FaEnvelope /><Text ml={2}>Contact</Text></Link>
            </Box>
          </Flex>
        </Box>
